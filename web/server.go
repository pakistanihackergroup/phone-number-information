// Package web includes code for the web server of pakistanihackergroup
//
...
import (
	...
	v2 "github.com/pakistanihackergroup/phone-number-information/v2/web/v2/api/server"
	"net/http"
)

// @title Phone-number-information REST API
